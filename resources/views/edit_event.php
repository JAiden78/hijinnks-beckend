        ...
        <div id="wrapper">
            ...
            <main id="main">
                ...
                <div id="content">
                    ...
                    <div class="p-details">
                        <form action="<?= asset('edit_event') ?>" id="form" method="post" class="login-form change-pass" enctype="multipart/form-data">

                            <?php if (isset($editUserEventBreadCrumb) && $editUserEventBreadCrumb == 1) { ?>
                                <input name="breadCrumb" type="hidden" value="user">
                            <?php } else if (isset($editEventBreadCrumb) && $editEventBreadCrumb == 1) { ?>
                                <input name="breadCrumb" type="hidden" value="event">
                            <?php } ?>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h3 class="heading-txt colored" style="margin-top: 10px;">Edit Event</h3>
                                        <?php
                                        ...
                                        <select name="interest[]" class="form-control" multiple="">
                                            ...
                                            if ($intrest_list) {
                                                foreach ($intrest_list as $key => $ivalue) {
                                                    ?>
                                                    <option value="<?= $ivalue->id ?>" <?= (in_array($ivalue->id, $intrest_ids) ? 'selected' : ''); ?>><?= $ivalue->title ?></option>
                                                <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="row" id="reocer_div" style="display: <?=$event->is_reoccuring == 1 ? 'block' : 'none'?>">
                                    <div class="col-sm-6">
                                        ...
                                        <select name="reoccure_type" class="form-control reocer_type">
                                            ...
                                            <option value="7" <?=($event->reoccure_type == '7')?'selected':''?>>Weekly</option>
                                            <option value="30" <?=($event->reoccure_type == '30')?'selected':''?>>Monthly</option>
                                            <option value="360" <?=($event->reoccure_type == '360')?'selected':''?>>Yearly</option>                                    
                                        </select>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <div id="days" style="display: <?=($event->reoccure_type == '7')?'block':'none'?>">
                                        ...
                                        <div id="years" style="display: <?=($event->reoccure_type == '360')?'block':'none'?>">
                                        ...
                                        <div id="month" style="display: <?=($event->reoccure_type == '30')?'block':'none'?>">
...
<?php } ?>
                                ...
                                <div class="row" style="text-align: center;">
                                    <div class="col-sm-12">
                                        <input type="submit" style="border-radius: 5px;" value="UPDATE EVENT">
                                    </div>
                                </div>
...
<?php include 'includes/footer.php'; ?>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            var utcEventStart = '<?php echo $event->event_date; ?>'; //set js variable for updated_at
            var utcEventEnd = '<?php echo $event->event_end_date; ?>'; //set js variable for updated_at
