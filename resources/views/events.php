                ...
                <div id="content">
                    ...
                    <div class="content-area">
                        ...
                        <form action="<?= asset('get_events') ?>" id="listing_filter_form" method="post">
                            ...
                            <?php if(isset($added_by_filter)){ ?>
                                <input name="event_added_by" value="<?php echo $added_by_filter; ?>" type="hidden" />
                            <?php } ?>
                            ...
                            <table id="myTableEvent">
                                ...
                                <?php $i=1; foreach ($events as $event) {
                                   ...
                                   $image = $event->cover;
                                    ...
                                    ?>
                                    <tr>
                                        <td style="width: 10px; text-align: center;"><?php echo $i;$i++; ?></td>
                                        <td><a href="<?= asset('event_details/'.$event->id) ?>" class="clickable"><span class="colored"><?= $event->title ?></span></a></td>
                                        ...
                                        <?php if(Auth::user()->user_type == 1){ ?>
                                            <td><a class="clickable" href="<?php  echo asset('event_members/'.$event->id)?>"><?= $event->Invites->count() ?></a></td>
                                        <?php } else { ?>
                                            <td><?= $event->Invites->count() ?></td>
                                        <?php } ?>
                                        <?php if(Auth::user()->user_type == 1){ ?>
                                            <td><a class="clickable" href="<?php if($event->arrived->count() > 0 ){ echo asset('event_rsvps/'.$event->id);} else{ echo '#';}?>"><?= $event->arrived->count() ?></a></td>
                                            <td><a class="clickable" href="<?php if($event->likes->count() > 0 ){ echo asset('event_liked_by/'.$event->id);} else{ echo '#';}?>"><?= $event->likes->count() ?></a></td>
                                        <?php } else { ?>
                                        ...
                                        <td>
                                            <a href="<?= asset( 'edit_event/'. $event->id ) ?>" title="Edit Event"><i class="fa fa-edit" aria-hidden="true"></i></a>
                                            <a href="#event<?= $event->id ?>" class="btn-popup"><i class="fa fa-trash" aria-hidden="true"></i></a><br>
<!--                                            <a class="btn-toggle">Show Details</a>-->
                                        </td>
                                    </tr>
